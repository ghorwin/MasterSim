...
Thunderbird kann so zwar verschlüsselte E-Mails schicken und empfangen, aber beim Speichern lokal bearbeiteter, verschlüsselter Mails gibts einen Fehler. Das müsste ich nochmal recherchieren.
