...
image::welcome_page_project_properties.png[pdfwidth=16cm]
...
Im Falle einer fehlenden Zeiteinheit in der Kopfzeile der ersten Spalte nimmt _MasterSim_ die Zeiteinheit **Sekunden** (s) an.
====
...
In dem seltenen Fall, wenn man Zeichenketten-Parameter mit führenden und abschließenden Leerzeichen festlegen möchte, kann man die Zeichenkette in "" einschließen. Beispiel:
 ...
 parameter building_model.configPara "   Zeichenkette mit Leerzeichen am Anfang und Ende     "
====
