...
public:
	...
	static int doubleEditTypeId();
	static int datTimeFormatTypeId();
	static int coordinateIndexTypeId();
public Q_SLOTS:
...
private:
	...
	Q_PRIVATE_SLOT(d_func(), void slotRangeChanged(QtProperty *, int, int, QString))
	...
	Q_PRIVATE_SLOT(d_func(), void slotVectorChanged(QtProperty *, const QVector<double> &))
