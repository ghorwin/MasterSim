...
class QtDoubleLineEditFactoryPrivate;

class QtDoubleLineEditFactory : public QtAbstractEditorFactory<QtDoubleEditPropertyManager>
{
	Q_OBJECT
public:
	QtDoubleLineEditFactory(QObject *parent = 0);
	~QtDoubleLineEditFactory();
protected:
	void connectPropertyManager(QtDoubleEditPropertyManager *manager);
	QWidget *createEditor(QtDoubleEditPropertyManager *manager, QtProperty *property,
				QWidget *parent);
	void disconnectPropertyManager(QtDoubleEditPropertyManager *manager);
private:
	QScopedPointer<QtDoubleLineEditFactoryPrivate> d_ptr;
	Q_DECLARE_PRIVATE(QtDoubleLineEditFactory)
	Q_DISABLE_COPY(QtDoubleLineEditFactory)
	Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, double))
	Q_PRIVATE_SLOT(d_func(), void slotRangeChanged(QtProperty *, double, double, QString))
	Q_PRIVATE_SLOT(d_func(), void slotSetValue(double))
	Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
};

class QtCoordinateIndexEditFactoryPrivate;

class QtCoordinateIndexEditFactory : public QtAbstractEditorFactory<QtCoordinateIndexPropertyManager>
{
	Q_OBJECT
public:
	QtCoordinateIndexEditFactory(QObject *parent = 0);
	~QtCoordinateIndexEditFactory();
protected:
	void connectPropertyManager(QtCoordinateIndexPropertyManager *manager);
	QWidget *createEditor(QtCoordinateIndexPropertyManager *manager, QtProperty *property,
				QWidget *parent);
	void disconnectPropertyManager(QtCoordinateIndexPropertyManager *manager);
private:
	QScopedPointer<QtCoordinateIndexEditFactoryPrivate> d_ptr;
	Q_DECLARE_PRIVATE(QtCoordinateIndexEditFactory)
	Q_DISABLE_COPY(QtCoordinateIndexEditFactory)
	Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, int))
	Q_PRIVATE_SLOT(d_func(), void slotCoordinateVectorChanged(QtProperty *, const QVector<double> &))
	Q_PRIVATE_SLOT(d_func(), void slotSpaceTypeChanged(QtProperty *, bool))
	Q_PRIVATE_SLOT(d_func(), void slotTimeUnitBaseChanged(QtProperty *, int))
	Q_PRIVATE_SLOT(d_func(), void slotTimeUnitDisplayChanged(QtProperty *, int))
	Q_PRIVATE_SLOT(d_func(), void slotSetValue(int))
	Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
};
...
class QtDateTimeFormatEditorFactoryPrivate;

class QtDateTimeFormatEditorFactory : public QtAbstractEditorFactory<QtDateTimeFormatPropertyManager>
{
	Q_OBJECT
public:
	QtDateTimeFormatEditorFactory(QObject *parent = 0);
	~QtDateTimeFormatEditorFactory();
protected:
	void connectPropertyManager(QtDateTimeFormatPropertyManager *manager);
	QWidget *createEditor(QtDateTimeFormatPropertyManager *manager, QtProperty *property,
				QWidget *parent);
	void disconnectPropertyManager(QtDateTimeFormatPropertyManager *manager);
private:
	QScopedPointer<QtDateTimeFormatEditorFactoryPrivate> d_ptr;
	Q_DECLARE_PRIVATE(QtDateTimeFormatEditorFactory)
	Q_DISABLE_COPY(QtDateTimeFormatEditorFactory)
	Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, const QStringList &))
	Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
	Q_PRIVATE_SLOT(d_func(), void slotSetValue(const QStringList &))
};
