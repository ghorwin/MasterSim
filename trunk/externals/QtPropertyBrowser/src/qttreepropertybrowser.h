...
public:
	...
	/*! If enabled, any change made to the tree view (collapsing/expanding of items)
		triggers a minimum/maximum size update, thus fixing the effective height of the property browser
		widget to its entire content.
	*/
	void setFixHeightToContents(bool enabled);
	QTreeWidget *treeWidget() const;

//	/*! Returns height of tree item. */
//	int itemHeight(const QModelIndex &index) const;
