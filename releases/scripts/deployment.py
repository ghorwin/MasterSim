...
"""
	...
	if currentOS   == "linux" or currentOS == "mac":
		...
		if sys.version_info >= (3, 0):
			print("Setting executable bit on 'deploy.sh' (Python 3)")
			os.chmod(pathToDeploy, 0o755) # Python 3 requires 0o to indicate octal numbers
		else:
			print("Setting executable bit on 'deploy.sh' (Python 2)")
			os.chmod(pathToDeploy, 493)
