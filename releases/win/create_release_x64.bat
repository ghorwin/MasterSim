...
if exist %GIT_WORKING_DIR%\MasterSim.git\release\win\VC19_x64\ (
	svn up %GIT_WORKING_DIR%\MasterSim.git\release\win\VC19_x64\
) ELSE (
	svn co svn+ssh://141.30.43.38/srv/svn/WinDeploymentLibs/VC19_x64  %GIT_WORKING_DIR%\MasterSim.git\release\win\VC19_x64
)
