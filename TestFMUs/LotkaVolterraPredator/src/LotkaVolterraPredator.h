...
#ifndef LotkaVolterraPredatorH
#define LotkaVolterraPredatorH

#include "fmi2common/InstanceData.h"

/*! This class wraps all data needed for a single instance of the FMU. */
class LotkaVolterraPredator : public InstanceData {
public:
	/*! Initializes empty instance. */
	LotkaVolterraPredator();
...
}; // class LotkaVolterraPredator

#endif // LotkaVolterraPredatorH
