...
cp fmus/Part1.fmu ../data/examples/linux64/Math_003_control_loop/fmus/IBK &&
cp fmus/Part2.fmu ../data/examples/linux64/Math_003_control_loop/fmus/IBK &&
cp fmus/Part3.fmu ../data/examples/linux64/Math_003_control_loop/fmus/IBK &&
cp fmus/Prey.fmu ../data/examples/linux64/Lotka_Volterra_System/fmus/IBK &&
cp fmus/Predator.fmu ../data/examples/linux64/Lotka_Volterra_System/fmus/IBK &&

echo "Copied FMUs to data/examples/linux64"
